    ...
    <section className='hero-slider'>
      <div className='hero-img-container'>
        <div className='polaroid-container first'>
          <img
            src='/images/Hero-Slider_Square_GoodBye-Sunshine_Just-A-Dash-Beauty.jpg'
        ...
        <div className='polaroid-container second'>
          <img
            src='/images/Hero-Slider_Square_Escape-in-Bora-Bora_Just-A-Dash-Beauty.jpg'
            alt='Model- About Page'
          />
        ...
        <div className='polaroid-container third'>
          <img
            src='/images/Hero-Slider_Square_No-Handyman-Needed_Just-A-Dash-Beauty.jpg'
            alt='Model- About Page'
          />
      ...
      <div className='text-container'>
        ...
        <button>
          <Link to='/shop/skintype=all&prodtype=all'>SHOP NOW</Link>
        </button>
      </div>
    </section>
  );
