      ...
      <BreadCrumb match={props.match}/>
        <section className="about-page">
            ...
            <p>Hi there,<br/><br/>
              ...
              <br/><br/>
              I decided to take the situation into my own hands and start an affordable skincare line especially created for young women. After many months in the making, <span class="bold">JUST A DASH</span> is finally completed  and I am really proud to have put on the market some incredible and affordable products that look and smell amazing and deliver great results, only using the best performing and proven natural ingredients!<br/><br/>
              I would love to see young women embracing their own skin and not afraid to leave the house without heavy make-up on.
              <br/><br/></p>
              <p>Here’s what we, at <span class="bold">JUST A DASH</span>, stand for:</p>
              <ul>
              ...
              <br/><br/>
              <p class="italic">-Greta</p>
              <p class="bold hot-pink">JUST A DASH</p>
        </section>
    </Fragment>
    )
  }
