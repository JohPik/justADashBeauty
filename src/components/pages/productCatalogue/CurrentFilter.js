        ...
        return (
          <Fragment>
            ...
            <div className='single-filter'>
              ...
              <button onClick={() => this.props.resetFilter('skinType')}>
                x
              </button>
            </div>
          </Fragment>
        ...
        return (
          <Fragment>
            ...
            <div className='single-filter'>
              ...
              <button onClick={() => this.props.resetFilter('prodType')}>
                x
              </button>
            </div>
          </Fragment>
    ...
    return (
      ...
      <Fragment>
        ...
        <form onSubmit={this.props.handleSubmit}>
          ...
          <div className='form-select form-radio'>
            <p className='form-subheading'>Product Type</p>
            <label className='radio-container'>
              All
              <input
                type='radio'
            ...
            <label className='radio-container'>
              ...
              <input
                ...
                value='toning mist'
                onChange={handleChangeProdType}
                checked={temp.prodTypeTemp === 'toning mist'}
              />
              <span className='checkmark'></span>
            </label>
            <label className='radio-container'>
    ...
    return (
      <Fragment>
        ...
        {this.state.showForm ? null : (
          <div className='current-filters'>
            ...
            <div className='show-form-button-container'>
              {this.props.prodType === 'all' &&
              this.props.skinType === 'all' ? (
                <button
                  className='show-form'
        ...
        <div
          ...
          style={this.state.showForm ? null : { display: 'none' }}
        >
          {this.displayForm()}
        </div>
      </Fragment>
