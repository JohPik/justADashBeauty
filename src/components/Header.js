...
const Header = (props) => {
  ...
  useEffect(() => {
    //make sure the mobile menu is closed after url change
          ...
          <section className='header'>
            ...
            <section className='header-navigation'>
              <div className='logo-container'>
                <Link to='/'>
                  <img
                    src='/images/pictograms/Just-A-Dash-Beauty_Logo.svg'
                    alt='Just A Dash Beauty Logo'
                    className='logo'
                  />
                </Link>
              </div>
                  ...
                  <li className='primary-nav-item'>
                    ...
                    <div className='dropdown-content'>
                      <div className='dropdown-col-1'>
                        ...
                        <Link to='/shop/skintype=normal&prodtype=all'>
                          Normal
                        </Link>
                      </div>
                      <div className='dropdown-col-2'>
                        ...
                        <Link to='/shop/skintype=all&prodtype=serum'>
                          Serum
                        </Link>
              ...
              <nav className='navbar-mobile'>
                ...
                <div
                  className={
                    secondaryMobileMenu
                      ? 'secondary-mobile-items visible'
                ...
                >
                  ...
                  <span
                    ...
                    onClick={() => SecondarymobileMenuToggle(false)}
                  >
                    return
                  </span>
